...
(eval-and-compile
  (defvar articblush-colors-alist
    '(("articblush-fg"                . "#")
      ...
      ("articblush-cyan"              . "#")
      ("articblush-white"             . "#")
      ("articblush-bright-black"      . "#")
      ("articblush-bright-red"        . "#")
      ("articblush-bright-green"      . "#")
      ("articblush-bright-yellow"     . "#")
      ("articblush-bright-blue"       . "#")
      ("articblush-bright-magenta"    . "#")
      ("articblush-bright-cyan"       . "#")
      ("articblush-bright-white"      . "#")
      ("articblush-comment"           . "#")
      ("articblush-highlight"         . "#")
      ("articblush-warning"           . "#")
      ("articblush-error"             . "#"))))
