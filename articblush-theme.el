...
(eval-and-compile
  (defvar articblush-colors-alist
    '(("articblush-fg"                . "#C5C8C9")
      ("articblush-bg"                . "#131A1C")
      ("articblush-black"             . "#1B2224")
      ("articblush-red"               . "#F65B5B")
      ("articblush-green"             . "#6BB05D")
      ("articblush-yellow"            . "#E59E67")
      ("articblush-blue"              . "#53A7BF")
      ("articblush-magenta"           . "#B185DB")
      ("articblush-cyan"              . "#51A39F")
      ("articblush-white"             . "#C4C4C4")
      ("articblush-bright-black"      . "#232A2C")
      ("articblush-bright-red"        . "#C26F6F")
      ("articblush-bright-green"      . "#8DC776")
      ("articblush-bright-yellow"     . "#E7AC7E")
      ("articblush-bright-blue"       . "#6CBAD1")
      ("articblush-bright-magenta"    . "#BB8FE5")
      ("articblush-bright-cyan"       . "#6DB0AD")
      ("articblush-bright-white"      . "#C5C8C9")
      ("articblush-comment"           . "#62686A")
      ("articblush-highlight"         . "#2F3638")
      ("articblush-warning"           . "#E6D967")
      ("articblush-error"             . "#E93D3D"))))
